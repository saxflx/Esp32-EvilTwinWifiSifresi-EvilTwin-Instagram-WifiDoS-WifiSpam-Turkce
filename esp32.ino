...
const char ssids[] PROGMEM = {
  "babalar firar\n"
  "saat 200 milyar\n"
  "kardesim o hareketi yanlis yapıyosun\n"
  "at kafasi\n"
  "Cafe Wifi\n"
  "Starbucks\n"
  "testesteron necmi\n"
  "fasulyesine oynamam ha\n"
  "He amk benidemi dovsunler\n"
  "Vur kürde amk kürdü\n"
  "banane amk\n"
  "fatih\n"
  "fatih 5G\n"
  ...
  "arkana bak\n"
  "Ankara Akdere mevzuya bak hele\n"
  "manifest ne amk\n"
  "bi kere yalim\n"
  "sa naber\n"
  "esp31\n"
  "level c5\n"
  "suraya c4 atacan\n"
  "apo hangi kapinin iti\n"
  "aponun amk\n"
  "selooo oc seloo\n"
  "seyhsaid (asildi)\n"
  "ismet nereyi imzaladin gine\n"
  "Saray WiFi\n"
  "JITEM\n"
};
...
<body>
  <h1>Wifi Spam</h1>
  <div class="status">Wifi Spam Başladı!</div>
   ...
   if (wifiSpamActive) {
    ...
    if (currentTime - attackTime > 100) {
      ...
      while (i < ssidsLen) {
        ...
        if (appendSpaces) {
          for (int k = 0; k < 3; k++) {
            packetCounter += esp_wifi_80211_tx(WIFI_IF_STA, beaconPacket, packetSize, false) == ESP_OK;
            delay(1);
          }
        } else {
